                ...
                @foreach ($urns as $urn)
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <a class="btn btn-warning" href="{{ route('urn.show', $urn->id) }}"><i class="fa fa-search"></i></a>
                            <a class="btn btn-primary" href="{{ route('urn.edit', $urn->id) }}" ><i class="fa fa-edit"></i></a>
                            <a class="btn btn-danger" href="{{ route('urn.destroy',  $urn->id) }}"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
        </table>
        <a class="btn btn-primary" href="{{ route('urn.create') }}" >Cadastrar</a>
    </div>
